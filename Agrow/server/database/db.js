...
const Connection = async (username, password) => {
    ...
    const URL = `mongodb://${username}:${password}@cluster0-shard-00-00.j2pfh.mongodb.net:27017,cluster0-shard-00-01.j2pfh.mongodb.net:27017,cluster0-shard-00-02.j2pfh.mongodb.net:27017/ECOMMERCE?ssl=true&replicaSet=atlas-23wwbe-shard-0&authSource=admin&retryWrites=true&w=majority`;
    try {
