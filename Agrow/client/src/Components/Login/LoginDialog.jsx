...
const useStyle = makeStyles({
    ...
    image: {
        backgroundImage: `url(${'https://i.postimg.cc/85Vs7zBR/18966447-removebg-preview-1.png'})`,
        background: '#81B622',
                ...
                <Box style={{display: 'flex'}}>
                    ...
                    </Box>
                    {
                        ...
                        <Box className={classes.login}>
                            ...
                            <Typography className={classes.text}>By continuing, you agree to Agrow's Terms of Use and Privacy Policy.</Typography>
                            ...
                            <Typography className={classes.createText} onClick={() => toggleSignup()}>New to Agrow? Create an account</Typography>
                        </Box> : 
                        <Box className={classes.login}>
